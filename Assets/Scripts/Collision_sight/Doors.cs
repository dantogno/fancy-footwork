...
public class Doors : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //}
        initalRotation = objectToEffect.transform.rotation;
    ...
    void Update()
    {
        ...
        if (isRotating &&!hasRotated)
            RotatePainting();
        if((objectToEffect.transform.rotation.ToEuler().y * (180 / Mathf.PI)) >= ((initalRotation.ToEuler().y * (180 / Mathf.PI))-70) 
            && (objectToEffect.transform.rotation.ToEuler().y * (180 / Mathf.PI)) < ((initalRotation.ToEuler().y * (180 / Mathf.PI)) - 55))
            objectToEffect.GetComponent<Rigidbody>().freezeRotation = true;
