...
namespace Gameplay
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        public void Simulate(
                CharacterController characterController, PlayerInput input)
        {
            ...
            _lookingAngles.y = Angles.Unwind(
                Mathf.Clamp(
                    Angles.ToRelative(_lookingAngles.y),
                    -60,
                    60));
            ...
            UpdateFootPlanting(transform, speedSqr, speedScalar, isJumping);
        }
        ...
        void UpdateFootPlanting(
                Transform transform, float speedSqr, float speedScalar, bool isJumping)
        {
            if (isJumping)
            {
                if ((_feetPlanted & 8) == 0)
